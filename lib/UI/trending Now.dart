          ...
          itemBuilder: (context, index) {
            return SizedBox(
                child: GestureDetector(onTap: (){
                  Navigator.of(context).push(MaterialPageRoute(builder: (_)=>Tv(id:data[index].id.toString() )));
                },
                  child: Row(
                    children: [
                      SizedBox(
                              ...
                              BlocListener<FavoriteBloc, FavoriteState>(
                                ...
                                child: InkWell(onTap: () {
                                  BlocProvider.of<FavoriteBloc>(context).add(
                                      FetchFavorite(varientId: data[index].variants![0].id.toString(),));
                                },
                                    child: Icon(
