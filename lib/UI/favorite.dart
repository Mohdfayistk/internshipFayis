                                ...
                                children: [
                                  Row(
                                    children: [
                                      ...
                                      BlocListener<RemoveFavoriteBloc,
                                          RemoveFavoriteState>(
                                        listener: (context, state) {
                                          if (state
                                              is RemoveFavoriteBlocLoading) {
                                            showDialog(
                                          ...
                                          if (state
                                              is RemoveFavoriteBlocLoaded) {
                                            BlocProvider.of<GetFavoriteBloc>(
                                                    context)
                                                .add(FetchGetFavorite());
                                            Navigator.of(context).pop();
                                            Fluttertoast.showToast(
